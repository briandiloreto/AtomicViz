...
* **Graph toolbar**
    * For a **Files graph**, choose whether to show function calls, class inheritance, or interface implementation
    * For a **Function graph**, choose the depth of the call hierarchy
...
* **Selection toolbar**
    ...
    * By default, you can only select a single graph item. To select multiple graph items, checkthe checkbox _**"Selection: Multi"**_ 
